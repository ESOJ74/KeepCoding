...
object JoinStreamStream {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val archivePath = "/media/jose/Repositorio/KeepCoding/Full Stack Big Data, AI & Machine Learning 8/big-data-processing/spark/spark-structured-streaming/spark_structured_streaming_base_solutions/src/main/resources/exercise3/stream-stream/archive"
    ...
    val appStream = spark
      ...
      .load("/media/jose/Repositorio/KeepCoding/Full Stack Big Data, AI & Machine Learning 8/big-data-processing/spark/spark-structured-streaming/spark_structured_streaming_base_solutions/src/main/resources/exercise3/stream-stream/input")
